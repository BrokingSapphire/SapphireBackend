...
const templateContentMap: Record<SmsTemplateType, string> = {
    ...
    [SmsTemplateType.DOCUMENTS_RECEIVED_CONFIRMATION]:
        'Dear {#var#}, we have received your documents for account opening. Your account will be activated within 12 to 24 working hours. Sapphire Broking',
    ...
    [SmsTemplateType.FORGET_MPIN]:
        'Your OTP to reset your Sapphire Terminal MPIN is {#var#}. Do not share this OTP. It is valid for 10 minutes. Sapphire Broking',
};
