...
import { RiskScore , occupationToRiskGroup } from '@app/database/db';
import {
    RiskCategory, 
    OccupationRiskGroup,
    } from '../modules/rms/rms.types';
...
export const calculateRiskScore = (
  ...
  const totalScore = annualIncomeScore + tradingExperienceScore + occupationScore + maritalStatusScore + politicallyExposedScore;
